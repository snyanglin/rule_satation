...
(function($) {
	...
	function _6(_7) {
		...
		if (_9.options.novalidate) {
			_8.bind("blur.validatebox", function() {
				var opts = _9.options;
				...
				if (charSet != null && charSet != "") {
					...
					switch (charSet) {
						case 'half' :
							_7.value = charSet_fullToHalf(str); break;
						case 'halfLower' :
							_7.value = charSet_fullToHalfLower(str); break;
						case 'halfUpper' :
							_7.value = charSet_fullToHalfUpper(str); break;
						case 'full' :
							_7.value = charSet_halfToFull(str); break;
						case 'fullLower' :
							_7.value = charSet_halfToFullLower(str); break;
						case 'fullUpper' :
							_7.value = charSet_halfToFullUpper(str); break;
						case 'lower' :
							_7.value = charSet_lower(str); break;
						case 'upper' :
							_7.value = charSet_upper(str); break;
					}
				}
			});
			// 根据charSet自动转换结束
	...
	function _14(_15) {
		...
		if ("undefined" == typeof _16 || _16 == null) {
			return true;
		}
		var _17 = _16.options;
		var box = $(_15);
		...
		if (_17.required) {
			if (_18 == "") {
				if (!box.hasClass("easyui-combobox") && !box.hasClass("easyui-combotree")) {
					box.addClass("validatebox-invalid");
				}
			...
			if (_29) {
				...
				$.data(this, "validatebox", {
					options : $.extend( {}, $.fn.validatebox.defaults,
							$.fn.validatebox.parseOptions(this), _27)
				});
			}
			_23(this);
			_14(this);
	...
	$.fn.validatebox.parseOptions = function(_2a) {
		var t = $(_2a);
		return $.extend( {}, $.parser.parseOptions(_2a, [ "validType",
