...
(function($) {
	...
	function _27(_28, _29) {
		...
		var onlyShow;
		if (_29) {
			onlyShow = _29.onlyShow;
			var forceOpen = _29.forceOpen;
			if (forceOpen != true) {
	...
	function _2e(_38, _39) {
		...
		var _3d = _3b.children("div.panel-header")
	...
	function _3e(_3f, _40) {
		...
		var _44 = _42.children("div.panel-header")
				.find("a.panel-tool-collapse");
	...
	$.fn.panel = function(_5d, _5e) {
		...
		return this.each(function() {
			...
			if (_5f) {
				...
				_60 = $.extend( {}, $.fn.panel.defaults, $.fn.panel
						.parseOptions(this), _5d);
				$(this).attr("title", "");
				_5f = $.data(this, "panel", {
					options : _60,
					panel : _f(this),
	...
	$.fn.panel.parseOptions = function(_6b) {
		var t = $(_6b);
		return $.extend( {}, $.parser.parseOptions(_6b, [ "id", "width",
